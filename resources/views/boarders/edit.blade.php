    ...
    <x-content-wrap class="max-w-3xl">
        <form class="flex flex-col" action="{{ route('boarders.update', $boarder) }}" method="POST"
            ...
            <div class="mb-4">
                ...
                <x-select name="profile_type">
                    @foreach (\App\Models\Boarder::$type as $type)
                        <option value="{{ $type }}" {{ $type === $boarder->profile_type ? 'selected' : '' }}>
                            {{ Str::ucfirst($type) }}
                        </option>
                    @endforeach
                </x-select>
            ...
            <div class="mb-4">
                ...
                <x-text-input id="last_name" class="block mt-1 w-full" type="text" name="last_name" :value="$boarder->last_name"
                    required />
            ...
            <div class="mb-4">
                ...
                <x-text-input id="name_of_guardian" class="block mt-1 w-full" type="text" name="name_of_guardian"
                    :value="$boarder->name_of_guardian" />
            ...
            <div class="mb-4">
                ...
                <x-text-input id="guardian_contact" class="block mt-1 w-full" type="text" name="guardian_contact"
                    :value="$boarder->guardian_contact" />
